        ...
        */
        ...
        if (e === "Failed to check owner in reveal winners") {
          ...
          HINT:   Use assert(false) to assert false
                  Use assert(true) to assert true
          ***********/
          assert(false, "Failed to check owner in reveal winners")
        } else {
          /**********
    ...
    ***********/
    return auctionInstance.register({ from: accounts[2] })
      .then(function (result) {
        ...
        ***********/
        return auctionInstance.winners.call(0, { from: accounts[0] })
      }).then(function (result) {
        /**********
        ...
        ***********/
        assert.notEqual(result, '0x0000000000000000000000000000000000000000', "the winner address should not the default address")
        /**********
        TASK 16: call winners function from accounts[0] to get the winner of item id 1
        ***********/
        return auctionInstance.winners.call(1, { from: accounts[0] })
      }).then(function (result) {
        /**********
        ...
        ***********/
        return auctionInstance.winners.call(2, { from: accounts[3] })
      }).then(function (result) {
        /**********
